...
public class TestConfig implements CommandLineRunner{
	...
	public void run(String... args) throws Exception {
		...
		Post p3 = new Post(null, sdf.parse("06/10/2024"), "Partiu Disney", "Vou viajar para Disney. Abraços!", alex);
		Post p4 = new Post(null, sdf.parse("06/10/2024"), "Brasil é campeão!", "Brasil é campeão da Copa do mundo 2026.", bob);

//		maria.getListPost().addAll(Arrays.asList(p1, p2));
